...
ActiveRecord::Schema.define(version: 20161124095600) do
  ...
  create_table "result_lessons", force: :cascade do |t|
    t.integer  "lesson_id"
    t.integer  "answer_id"
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.string   "word"
    t.integer  "word_id"
    t.index ["answer_id"], name: "index_result_lessons_on_answer_id"
    t.index ["lesson_id"], name: "index_result_lessons_on_lesson_id"
    t.index ["word_id"], name: "index_result_lessons_on_word_id"
  end
